const METRICS = [
  { label: "CPU Usage", value: 34, accent: "success" },
  { label: "Memory", value: 58, accent: "accent" },
  { label: "Queue Depth", value: 12, accent: "ai" },
  { label: "API Latency (p95)", value: 21, suffix: "ms shown as %", accent: "warning", display: "96ms" },
];
      ...
      <div className="mt-5 space-y-4">
        {METRICS.map((m) => (
          <div key={m.label}>
            ...
            <div className="mt-1.5 h-1.5 w-full overflow-hidden rounded-full panel-bg-strong">
              <div
